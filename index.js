...
var blue       = 'hsla(227, 93%, 24%, 1)'
var orange     = 'hsla(24, 97%, 38%, 1)'
var red        = 'hsla(26, 82%, 58%, 1)'
/*-----------------------------------------------------------------------------
  LOADING FONT
-----------------------------------------------------------------------------*/
var links = ["https://fonts.googleapis.com/css?family=Indie+Flower"]
...
function quizComponent () {
      ...
      <div class="${css.quiz}">
        ...
        <div class="${css.instruction}">
          ...
          (1 - don't agree at all, 6 - completely agree)
           ...
           <img src="http://b.dryicons.com/images/icon_sets/artistica_icons_set/png/256x256/back.png" class="${css.backImg}">
  ...
  function sendData(results) {
    var request  = {
      url          : 'https://esovaquiz.firebaseio.com/resl.json',
      method       : 'POST',
  ...
  function createChart(ctx, myData) {
    minixhr('https://esovaquiz.firebaseio.com/resl.json', responseHandler)
